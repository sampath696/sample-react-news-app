...
const Entertainment = () => {
  ...
  useEffect(() => {
    ...
    var url =
      "http://newsapi.org/v2/top-headlines?country=in&category=entertainment&apiKey=ed60638fa7674d3d9b592036d42ae4e5";
        ...
        {article.map((item, index) => {
          return (
            <div className="demo" background={item.urlToImage} key={index}>
              ...
              <br />
              <a className="read" href={item.url} rel="noreferrer" target="_blank">
                read more
              </a>
              <br />
              <br />
